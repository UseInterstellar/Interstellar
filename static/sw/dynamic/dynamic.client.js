(() => {
    ...
    i.d = (e, t) => {
        ...
        var eJ, e0 = {
            ...
            e1 = (eH.GENERATOR = e0, {}),
            e2 = (eH.baseGenerator = e0, q = e3, eH = [{
                key: "write",
                value: function(e) {
                    this.output += e
                }
        ...
        function e4(e, t) {
            return (t = new e2(t)).generator[e.type](e, t), t.output
        }
        var e6 = i(206);
        let e5 = class {
            constructor(e) {
                ...
                }), this.setCookieParser = eU, this.bowser = e6, this.ctx = e
            }
        };

        function e9(e, t, i, r, n = "", s = !1, a = "") {
            var o;
        ...
        class e8 {
            constructor(e) {
                this.generateHead = e9, this.config = [{
                    elements: "all",
                    tags: ["style"],
                    action: "css"
                }, {
...
`).replace(/<(script|link)\b[^>]*>/g, (e, t) => e.replace(/\snonce\s*=\s*"[^"]*"/, e => e.replace("nonce", "nononce")).replace(/\sintegrity\s*=\s*"[^"]*"/, e => e.replace("integrity", "nointegrity"))))
                    ...
                    case "MemberExpression":
                        ! function(e, t = {}, i = {}) {
                            ...
                            if (e.object.name += "", "AssignmentExpression" !== t.type && t.left !== e) {
                                if ("postMessage" == e.property.value && "CallExpression" == t.type && t.callee == e || "postMessage" == e.object.value && "CallExpression" == t.type && t.callee == e) return ti(e);
                        ...
                        break;
                    case "Literal":
                        [c, h = {}] = [e, i], c.value instanceof String && ("__dynamic" == c.value && (c.value = "undefined"), ["location", "parent", "top", "postMessage"].includes(c.value)) && ("postMessage" == c.value && "AssignmentExpression" != h.type && h.left != c && ti(c), "location" == c.value && (c.value = "__dynamic$location"), "__dynamic" == c.value && (c.value = "undefined"), "eval" == c.value) && (c.value = "__dynamic$eval");
                        break;
                    case "CallExpression":
                        ! function(e, t = {}) {
                            if ("AssignmentExpression" != t.type || t.left != e) {
                                ...
                                if ("MemberExpression" == e.callee.type) {
                                    ...
                                    "eval" == e.callee.object.name && tr(e)
                                }
        ...
        class ts {
            constructor(e) {
                this.iterate = te, this.process = tt, this.emit = tn, this.ctx = e.ctx
            }
            rewrite(e, t = {}, i = !0, r = {}) {
...
` + e;
      ...
      ` + e)
        ...
        let to = {
            ...
            tc = class {
                constructor(e) {
                    this.ctx = e, this.html = new e8(this), this.srcset = to, this.js = new ts(this), this.css = new e7(this), this.man = new ta(this)
                }
            };
        ...
        function td(e, t, i) {
            ...
            return o = this, c = void 0, l = void 0, p = function*() {
                for (let p in e)
                    ...
                    try {
                        for (var o, c = !0, l = (n = void 0, tu(e[p])); !(r = (o = yield l.next()).done);) {
                            a = o.value, c = !1;
                            try {
...
self.document?.currentScript?.remove();`], {
        ...
        let tE = class {
            constructor(e) {
                this.route = tl, this.routePath = tp, this.path = th, this.resHeader = td, this.reqHeader = tm, this.clone = tf, this.class = ty, this.file = tg, this.edit = t_, this.error = tv, this.encode = tw, this.rewritePath = tS, this.about = tb, this.ctx = e
            }
        };
        ...
        let tA = class {
                constructor(e) {
                    this.encode = tk, this.decode = tC, this.ctx = e
                }
            },
            tP = /^(#|about:|mailto:|blob:|javascript:)/g,
            tI = /^data:([a-z\/A-Z0-9\-\+]+);?(charset\=[\-A-Za-z0-9]+)?;?(base64)?[;,]*(.*)/g,
            tL = /^([\/A-Za-z0-9\-%]+)(http[s]?:\/\/.*)/g;
        class tO {
            constructor(e) {
                this.BypassRegex = tP, this.DataRegex = tI, this.WeirdRegex = tL, this.ctx = e
            }
        }
        ...
        let tM = class extends class {
                constructor() {}
            } {
                constructor(e) {
                    super(), this.load = tT, this.ctx = e
                }
            },
            tR = {
        ...
        let tj = class {
            constructor(e) {
                this.html = tB, this.js = tV, this.css = tN, this.ctx = e
            }
        };
        ...
        let t1 = e => e ? e.split(";").map(e => e.split("=")).reduce((e, t) => (e[t[0].trim()] = t[1].trim(), e), {}) : {},
            t2 = (e = []) => e.map(e => e.name + "=" + e.value).join("; ");
        ...
        function t3(e) {
            if (delete e.Document.prototype.cookie, e.__dynamic.define(e.document, "cookie", {
                    ...
                    set(t) {
                        ...
                        }), (t = t1(e.__dynamic.cookie.str || ""))[i.name] = i.value, e.__dynamic.cookie.str = t2(Object.entries(t).map(e => ({
                            name: e[0],
                            value: e[1]
                        })))
                    }
                ...
                e.navigator.serviceWorker.onmessage = ({
                    ...
                    var i, r;
                    t.host == e.__dynamic.location.host && "set-cookie" == t.type && (i = e.__dynamic.modules.cookie.parse(t.val), (r = t1(e.__dynamic.cookie.str || ""))[Object.entries(i)[0][0]] = Object.entries(i)[0][1], e.__dynamic.cookie.str = t2(Object.entries(r).map(e => ({
                        name: e[0],
                        value: e[1]
        ...
        class ii {
            constructor(e) {
                this.methods = it, "DedicatedWorkerGlobalScope" == self.constructor.name || "SharedWorkerGlobalScope" == self.constructor.name ? (this.message = tK, this.location = tD, this.window = t$, this.get = tF, this.reflect = tY, this.imports = tX, this.blob = t6, this.mutation = t5) : (this.location = tD, this.get = tF, this.window = t$, this.attr = tH, this.worker = tW, this.history = tq, this.ws = tG, this.fetch = tz, this.message = tK, this.policy = t7, this.write = tQ, this.imports = tX, this.reflect = tY, this.niche = tZ, this.storage = tJ, this.navigator = t0, this.cookie = t3, this.style = t4, this.blob = t6, this.mutation = t5, this.eval = t9, this.func = t8, this.rtc = ie, this.dom = tU), this.ctx = e
            }
        }
        ...
        let is = {
            open: () => ir(void 0, void 0, void 0, function*() {
            ...
            set: (e, t, i) => ir(void 0, void 0, void 0, function*() {
                var r;
                return ((e = t.domain ? t.domain : e).startsWith(".") && (e = e.slice(1)), t.expires && new Date(t.expires) < new Date) ? is.remove(e, t, i) : (yield(yield i).put("__dynamic$cookies", ((r = (r = yield(yield i).get("__dynamic$cookies", e)) || []).find(e => e.name == t.name) ? r[r.findIndex(e => e.name == t.name)] = {
                    name: t.name,
                    value: t.value,
                    expires: t.expires
                } : r.push({
            ...
            get: (e, t) => ir(void 0, void 0, void 0, function*() {
                var i = e.replace(/^(.*\.)?([^.]*\..*)$/g, "$2"),
                    ...
                    if (n)
                        for (var {
                            ...
                            if (o && new Date(o) <= new Date) {
                                is.remove(e, n.find(e => e.name == s && e.value == a && e.expires == o), t);
                                continue
                            }
            ...
            remove: (e, t, i) => ir(void 0, void 0, void 0, function*() {
            ...
            update: (e, t) => ir(void 0, void 0, void 0, function*() {
                var i = e.replace(/^(.*\.)?([^.]*\..*)$/g, "$2"),
                ...
                if (i)
                    for (var {
                        ...
                        of i) s && new Date(s) <= new Date && is.remove(e, {
                        name: r,
                        value: n,
                        expires: s
                    }, t);
        ...
        class io {
            constructor(e) {
                this.db = is, this.ctx = e
            }
            get(e) {
                return ia(this, void 0, void 0, function*() {
                    return this._db || (this._db = this.db.open()), t2((yield is.get(e, this._db)))
                })
            }
            set(e, t = "") {
                return ia(this, void 0, void 0, function*() {
                    return t = this.ctx.modules.setCookieParser.parse(t, {
                        decodeValues: !1
                    })[0], this._db || (this._db = this.db.open()), yield is.set(e, t, this._db)
                })
            }
            open() {
                return ia(this, void 0, void 0, function*() {
            ...
            update(e) {
                return ia(this, void 0, void 0, function*() {
                    return this._db || (this._db = this.db.open()), yield is.update(e, this._db)
                })
            }
        }
        let ic = {
        ...
        class id {
            ...
            constructor(e) {
                this.modules = new e5(this), this.util = new tE(this), this.meta = new tM(this), this.regex = new tO(this), this.rewrite = new tc(this), this.url = new tA(this), this.is = new tj(this), this.cookies = new io(this), this.client = new ii(this), this.encoding = a, this.headers = tR, this.listeners = [], e && !this.config && (this.config = e), e && this.util.encode(self)
            }
        }! function e(t, i = {}, r = "") {
            if (t.hasOwnProperty("__dynamic")) return !1;
            t.hasOwnProperty("__dynamic$config") || (t.__dynamic$config = i), null != (i = t.parent) && i.__dynamic && (t.__dynamic$bare = t.parent.__dynamic$bare);
            var n, i = new id(t.__dynamic$config);
            for (n of (i.config.bare.path = "string" == typeof i.config.bare.path || i.config.bare.path instanceof URL ? new URL(i.config.bare.path, t.location) : i.config.bare.path.map(e => new URL(e, t.location)), t.__dynamic$baseURL = r || t.__dynamic$url || i.url.decode(location.pathname + location.search + location.hash) || "", t.__dynamic = i, t.__dynamic.bare = new t.__dynamic.modules.bare.BareClient(t.__dynamic$config.bare.path, t.__dynamic$bare), t.__dynamic.meta.load(new URL(t.__dynamic$baseURL)), (r = null, r = t.__dynamic).define = new t.Proxy(t.Object.defineProperty, {
                    apply(e, t, i) {
                        try {
                ...
                }), r.defines = new t.Proxy(t.Object.defineProperties, {
                    apply(e, t, i) {
                        try {
                            return Reflect.apply(e, t, i)
                        } catch (e) {
                ...
                }), t.parent && (r.parent = t.parent), t.top && (r.top = t.top), t.document && (r.elements = {
                    attributes: ["src", "href", "srcset", "action", "data", "integrity", "nonce", "imagesrcset"],
                    iframeSrc: Object.getOwnPropertyDescriptor(t.HTMLIFrameElement.prototype, "src"),
                    contentWindow: Object.getOwnPropertyDescriptor(t.HTMLIFrameElement.prototype, "contentWindow"),
                    innerHTML: Object.getOwnPropertyDescriptor(t.Element.prototype, "innerHTML"),
                    outerHTML: Object.getOwnPropertyDescriptor(t.Element.prototype, "outerHTML"),
                    attrValue: Object.getOwnPropertyDescriptor(t.Attr.prototype, "value"),
                    setAttribute: t.Element.prototype.setAttribute,
                    getAttribute: t.Element.prototype.getAttribute,
                    removeAttribute: t.Element.prototype.removeAttribute,
                    hasAttribute: t.Element.prototype.hasAttribute,
                    cloneNode: t.Node.prototype.cloneNode,
                    addEventListener: t.Node.prototype.addEventListener,
                    config: [{
                        elements: [t.HTMLScriptElement, t.HTMLIFrameElement, t.HTMLEmbedElement, t.HTMLInputElement, t.HTMLTrackElement, t.HTMLMediaElement, t.HTMLSourceElement, t.Image, t.HTMLImageElement],
                        tags: ["src"],
                        action: "url"
                    }, {
                        elements: [t.HTMLSourceElement, t.HTMLImageElement],
                        tags: ["srcset"],
                        action: "srcset"
                    }, {
                        elements: [t.HTMLAnchorElement, t.HTMLLinkElement, t.HTMLAreaElement, t.SVGImageElement, t.HTMLBaseElement],
                        tags: ["href"],
                        action: "url"
                    }, {
                        elements: [t.HTMLIFrameElement],
                        tags: ["contentWindow", "contentDocument"],
                        action: "window"
                    }, {
                        elements: [t.HTMLFormElement],
                        tags: ["action"],
                        action: "url"
                    }, {
                        elements: [t.HTMLObjectElement],
                        tags: ["data"],
                        action: "url"
                    }, {
                        elements: [t.HTMLScriptElement, t.HTMLLinkElement],
                        tags: ["integrity"],
                        action: "rewrite",
                        new: "nointegrity"
                    }, {
                        ...
                        elements: [t.HTMLElement],
                        tags: ["style"],
                        action: "css"
                    }, {
                        elements: [t.HTMLLinkElement],
                        tags: ["imageSrcset"],
                        action: "srcset"
                    }],
                    createGetter: e => ({
                        get() {
                            return new URL(this.href || t.__dynamic$location.href)[e]
                        },
                        set(e) {}
                    }),
                    client: e
                }, t.__dynamic.baseURL = t.document ? new URL(t.__dynamic.url.decode(t.document.baseURI)) : null), t.document && (r.cookie = {
                    str: t.__dynamic$cookie || "",
                    desc: Object.getOwnPropertyDescriptor(t.Document.prototype, "cookie")
                }), t.XMLHttpRequest && (r.http = {
                    XMLResponseURL: Object.getOwnPropertyDescriptor(t.XMLHttpRequest.prototype, "responseURL"),
                    ResponseURL: Object.getOwnPropertyDescriptor(t.Response.prototype, "url"),
                    RequestURL: Object.getOwnPropertyDescriptor(t.Request.prototype, "url"),
                    XMLHttpRequest: t.XMLHttpRequest
                }), t.Storage && (r.storage = {
                    localStorage: t.localStorage,
                    sessionStorage: t.sessionStorage,
                    keys: {
                        localStorage: Object.keys(t.localStorage),
                        sessionStorage: Object.keys(t.sessionStorage)
                    },
                    ...
                    localStorage: r.util.clone(r.storage.localStorage),
                    sessionStorage: r.util.clone(r.storage.sessionStorage)
                }), t.RTCPeerConnection && (r.webrtc = {
                    endpoints: ["stun:stun.webice.org"]
                }), t.trustedTypes && (r.trustedTypes = {
                    policy: t.trustedTypes.createPolicy("dynamic", {
                        createHTML: e => e,
                        createScript: e => e,
                        createScriptURL: e => e,
                        createURL: e => e
                    }),
                    createScript: t.TrustedTypePolicy.prototype.createScript
                }), t.__dynamic$config.tab && (t.document && t.__dynamic$config.tab.title && (document.title = t.__dynamic$config.tab.title, r.define(t.document, "title", {
                    get: () => t.__dynamic$config.tab.title,
                    set: e => e
                })), t.__dynamic$config.tab.icon && (t.__dynamic$icon = t.__dynamic$config.tab.icon), t.Navigator) && t.__dynamic$config.tab.ua && r.define(t.navigator, "userAgent", {
                    get: () => t.__dynamic$config.tab.ua,
                    set() {}
                }), t.__dynamic.wrap = function(e, i, r) {
                    if (e.__dynamic$target) return e;
                    if (e.toString().includes("{ [native code] }") && !e.prototype) return n = function(...n) {
                        if ("string" == typeof r) {
                            var s = t.__dynamic.fire(r, this ? [this, ...n] : n);
                            if (s) return s
                        }
                        return i.call(this, e, ...n)
                    }, t.__dynamic.define(s = function(...e) {
                        return n.call(this, ...e)
                    }, "name", {
                        value: e.name,
                        writable: !1
                    }), s.__dynamic$target = e, s.toString = () => `function ${e.name}() { [native code] }`, s;
                    try {
                        var n, s, a = class extends e {
                            constructor(...t) {
                                var n = [...t];
                                super(...t = i.call(e, e, ...t) || t), r && r(this, n)
                            }
                        };
                ...
                }, t.__dynamic.client.methods)) {
                let e = n.name;
                var s = Object.entries(t.__dynamic.client).find(t => t[0] == e);
                "mutation" == e && t.frameElement || "self" == n.function && s[1](t)
            }
            return t
        }(self)
    })()
